...
|---|---|---|---|---|
| **K1** | Shorts | 50-60 sn | Tek soru-cevap mikro | 0 |
| **K2** | Konsept açıklayıcı | 6-10 dk | "X nedir?" sade konu | 4-5 |
| **K3** | Standart pillar (varsayılan) | 10-15 dk | Derin kanıt + klinik karar + görüş | 5-7 |
| **K4** | Uzun pillar / Live Q&A | 15-25 dk | Çok yönlü, panel, abone Q&A | 7-10 |
| **K5** | Konuk segmenti / podcast | 20-40 dk | Uzman ile diyalog | 8-12 |
...
- Q&A ya da panel → **K4**
- Pillar makaleden 60sn kompresyon → **K1**
...
**Kontrol:**
- [ ] İlk 5 saniyede konu netleşti mi?
...
> **2026-04-26 güncelleme:** Eski 5-beat (A→B→C→D→E) **4-beat'e indirildi**. Eski C+D ("kim için" + "klinik pratik") sıkça örtüşüyordu; birleştirildi.

| Beat | Soru | İçerik | Tipik süre (K3) |
|---|---|---|---|
| **A. Konsept** | "X tam olarak ne?" | Terim açıklaması, mekanizma temeli | 1:00-3:00 |
| **B. Kanıt** | "Çalışmalar ne diyor?" | RCT, meta-analiz, kılavuz (ESHRE/NAMS/NICE/IMS/Cochrane), GRADE | 3:00-6:00 |
| **C. Klinik karar** | "Kim için, kim için değil — pratikte nasıl?" | Endikasyon + kontrendikasyon + klinik pratik birleşik; alternatif, maliyet | 6:00-9:00 |
...
### 4. CTA + disclaimer — 1 dakika

- Nötr CTA: "Detay için tupbebek.com" / "Plus d'infos sur draksoyivf.com" — UTM linkli
- "Sorular için yorum" — yanıt vaadi (yorum yanıtlama sistemi devrede)
...
- Yanıt vaadi: "Sorularınız için yorum yazın, yanıtlamaya çalışacağım"
- Kanıt referansı: "ESHRE 2023 / NAMS 2023 / NICE NG23" — hangisi geçerliyse
- Kaynak: "Yazılı kaynak için tupbebek.com / draksoyivf.com"
- Disclaimer hatırlatma satırı (yorum yanıtlama sistemi `disclaimer.md` ile uyumlu)
...
- [ ] Hedef süre seçilen kategori sınırında
- [ ] 7 bölüm tam (K2-K4 için): Hook + Bağlam + 4 beat + CTA + End screen + Description + Sabitlenmiş yorum
- [ ] Beat D (Dr. Aksoy yorumu) klinik gözlem + kanıt ayrımı net
- [ ] CTA nötr (satış dili yok)
- [ ] Disclaimer sesli + on-screen + description
- [ ] Chapter sayısı süre kategorisine uygun (K2: 4-5, K3: 5-7, K4: 7-10, K5: 8-12)
...
- [ ] Hashtag 3-5 adet, anahtar kelime odaklı
- [ ] Sabitlenmiş yorum kanıt referansı + soru-cevap vaadi
...
Her 8-12 dk video → 2-3 mikro-içerik (60 sn) türeyebilir.

**Türetme şablonu:**

1. **Hook (5 sn) + Tek soru (10 sn) + Cevap (40 sn) + CTA (5 sn)**
...
4. CTA = "Detay tam video açıklamada" — ana videoya çapraz link
